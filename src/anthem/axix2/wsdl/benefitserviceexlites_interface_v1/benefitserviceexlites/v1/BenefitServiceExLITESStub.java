...
public class BenefitServiceExLITESStub extends org.apache.axis2.client.Stub {
    ...
    static {
        ...
        try {
            jc = javax.xml.bind.JAXBContext.newInstance(GetAcctBalanceLITESRequest.class,
                    GetAcctBalanceLITESResponse.class,
                    ExceptionListType.class,
                    ESBHeaderType.class);
    ...
    public GetAcctBalanceLITESResponse getAcctBalanceLITES(
        ...
        try {
            ...
            return (GetAcctBalanceLITESResponse) object;
                ...
                if (faultExceptionNameMap.containsKey(
                    ...
                    try {
                        ...
                        if (ex instanceof GetAcctBalanceLITESFault) {
                            throw (GetAcctBalanceLITESFault) ex;
                        }
     ...
     *
     * @see BenefitServiceExLITES#startgetAcctBalanceLITES
     * @param getAcctBalanceLITESRequest0
     * @param eSBHeader1
     */
    ...
    private org.apache.axiom.om.OMElement toOM(
        ...
        try {
            ...
            JaxbRIDataSource source = new JaxbRIDataSource(GetAcctBalanceLITESRequest.class,
    ...
    private org.apache.axiom.om.OMElement toOM(
        ...
        try {
            ...
            JaxbRIDataSource source = new JaxbRIDataSource(GetAcctBalanceLITESResponse.class,
                    param, marshaller, methodQName.getNamespaceURI(),
                    methodQName.getLocalPart());
            org.apache.axiom.om.OMNamespace namespace = factory.createOMNamespace(methodQName.getNamespaceURI(),
                    null);
    ...
    private org.apache.axiom.om.OMElement toOM(
        ...
        try {
            ...
            JaxbRIDataSource source = new JaxbRIDataSource(ExceptionListType.class,
                    param, marshaller, methodQName.getNamespaceURI(),
                    methodQName.getLocalPart());
            org.apache.axiom.om.OMNamespace namespace = factory.createOMNamespace(methodQName.getNamespaceURI(),
                    null);
    ...
    private org.apache.axiom.om.OMElement toOM(
        ...
        try {
            ...
            JaxbRIDataSource source = new JaxbRIDataSource(ESBHeaderType.class,
                    param, marshaller, methodQName.getNamespaceURI(),
                    methodQName.getLocalPart());
            org.apache.axiom.om.OMNamespace namespace = factory.createOMNamespace(methodQName.getNamespaceURI(),
                    null);
